...
from utils.models import get_vit_model
...
def train_vit(config_path="configs/config.yaml"):
    """ViT 모델 학습 메인 함수"""
    # 설정 로드
    ...
    print(f"Model: {config['models']['vit']['name']}")
    ...
    # 히스토리 저장
    history_path = os.path.join(config["training"]["log_dir"], "vit_history.json")
